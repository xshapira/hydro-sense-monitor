...
export default function Home({ showDevTools }: HomeProps = {}) {
  ...
  const isDevToolsEnabled = showDevTools ?? import.meta.env?.VITE_SHOW_DEV_TOOLS === "true"
      ...
      <header className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-center h-20">
            <h1 className="text-3xl font-semibold text-gray-900">HydroSense Monitor</h1>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-3xl mx-auto px-4 pt-20 pb-12">
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-md p-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Units Overview</h2>
          ...
          <div className="bg-white rounded-xl shadow-md p-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Fetch Unit Alerts</h2>
            <p className="text-gray-600 text-sm mb-4">
              View recent alerts and sensor readings that need attention for a specific unit
            </p>
